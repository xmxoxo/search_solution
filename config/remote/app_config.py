...
# One-API服务密钥 keyi_saas
ONE_API_KEY = os.getenv("ONE_API_KEY", 'sk-XD86EujjqzvXzGdG25E2Bb7bF4994c439586A8B3653427B2')
# One-API服务地址
ONE_API_BASE_URL = os.getenv("ONE_API_BASE_URL", "http://172.30.1.124:9300/v1")
...
# Redis连接配置
GBL_REDIS_CONFIG = {
    "host": os.getenv("REDIS_HOST", "172.30.1.110"),            # Redis 本机主机地址
    "port": int(os.getenv("REDIS_PORT", 6379)),                 # Redis端口
    "password": os.getenv("REDIS_PASSWORD", "k8008.com"),       # Redis密码(可选)
    "db": int(os.getenv("REDIS_DB", 1))                         # Redis数据库编号
}

# SSDB 连接地址
SSDB_IP = os.getenv("SSDB_IP", "172.30.1.110")
SSDB_PORT = int(os.getenv("SSDB_PORT", 8888))

# Milvus向量数据库
MILVUS_HOST = os.getenv("MILVUS_HOST", '172.30.1.110')
...
# API端口地址 容器名: ime-api  本机IP:172.30.1.110
API_BASE_URL = "http://ime-api:5310"
